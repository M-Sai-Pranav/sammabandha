          ...
          <div style={{ ...carouselCardStyles, marginTop: '28%' }}>
            ...
            <>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '40px' }}>
                <div style={{ flex: 1 }}>
                  <Typography variant="h4" style={{ marginBottom: '20px' }}>Priyajit and Monisa</Typography>
            ...
            <>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '40px' }}>
                <div style={{ flex: 1 }}>
                  <Typography variant="h4" style={{ marginBottom: '20px' }}>Ajay and Swapna</Typography>
                  <Typography variant="body1" style={{ fontSize: '1.8rem' }}>
                    A couple who find their relationship to be based on friendship
                    from the very beginning
                    and attribute it to the strength of their bond.
              ...
              <Typography variant="body1" style={{ fontSize: '1.8rem' }}>- Ajay and Swapna</Typography>
            </>
            )}
            ...
            <>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '40px' }}>
                <div style={{ flex: 1 }}>
                  <Typography variant="h4" style={{ marginBottom: '20px' }}>Sunny and Sandhya</Typography>
                  <Typography variant="body1" style={{ fontSize: '1.8rem' }}>
                    A couple who find their relationship to be based on friendship
                    from the very beginning
                    and attribute it to the strength of their bond.
              ...
              <Typography variant="body1" style={{ fontSize: '1.8rem' }}>- Sai and Sandhya</Typography>
            </>
            )}
            ...
            <>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '40px' }}>
                <div style={{ flex: 1 }}>
                  <Typography variant="h4" style={{ marginBottom: '20px' }}>Mahesh and Namratha</Typography>
                  <Typography variant="body1" style={{ fontSize: '1.8rem' }}>
                    A couple who find their relationship to be based on friendship
                    from the very beginning
                    and attribute it to the strength of their bond.
